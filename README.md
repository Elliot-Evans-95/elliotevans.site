This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). ![Travis](https://travis-ci.org/Elliot-Evans-95/elliotevans.net.svg?branch=master)
...
```js
import React, { Component } from 'react';
import Button from EEButton; // Import a component from another file
